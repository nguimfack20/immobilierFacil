            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8 col-md-offset-2 intro-text">
                        ...
                        <p>. Vous recherchez une plateforme fiable? </p>
                        <p> Vous permettant d'acheter , vendre ou louer des biens immobiliers en toute transparence
                            devant un notaire?
                            100% rapide et sécurisée
                            Souriez , vous etes au endroit.</p>

                        <a href="#about" class="btn btn-custom btn-lg page-scroll">Qui sommes nous</a></div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-12 col-md-6 col-md-offset-1">
                <h3>Avez vous un projet de construction?</h3>
                <p>Commencez par remplir ce formulaire et nos experts y repondrons dans les brefs délai</p>
            </div>
            <div class="col-xs-12 col-md-4 text-center"><a href="#contact" class="btn btn-custom btn-lg page-scroll">Demandez
                    gratuitement un dévis</a></div>
        </div>
    </div>
</div>
<!-- About Section -->
<div id="about">
    <div class="container">
        <div class="row">
            <div class="col-xs-1 col-md-4"><img src="img/rod.png" class="img-responsive" alt="">
                Ing Nguimfack Rodrigue, CEO IMMOBILIERFACIL
            ...
            <div class="col-xs-12 col-md-6">
                <div class="about-text">
                    ...
                    <p>Votre plateforme immobilière est le fruit du savoir et du savoir-faire d'une équipe
                        d'ingénieurs,de spécialites en batiment, de notaire et aussi d'agents de mairies .</p>
                    <h3>Pourqoui devriez vous nous faire confiance?</h3>
                    <div class="list-style">
                        <div class="col-lg-6 col-sm-6 col-xs-12">
                            <ul>
                                <li>des spécialistes en BTP</li>
                                <li>Disponibilité d'un notaire</li>
                                <li>Qualité selon vos besoins</li>
                        ...
                        <div class="col-lg-6 col-sm-6 col-xs-12">
                            <ul>
                                ...
                                <li>Frais payable en plusieurs tranches</li>
                                <li>disponibilité des plans urbains</li>
                            </ul>
                        </div>
                    </div>
                </div>
...
<div id="services">
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="service-media"><img src="img/services/vendre.jpg" alt=" "></div>
                <div class="service-desc">
                    <h3>Achat, vente et location de biens</h3>
            ...
            <div class="col-md-4">
                <div class="service-media"><img src="img/services/assistance.png" alt=" "></div>
                <div class="service-desc">
                    <h3>Assistance et conseils pour vos projets</h3>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis sed dapibus leo nec ornare diam
                        sedasd commodo nibh ante facilisis bibendum dolor feugiat at.</p>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="service-media"><img src="img/services/plan.jpg" alt=" "></div>
                <div class="service-desc">
                    <h3>réalisations des plans 3D/2D</h3>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis sed dapibus leo nec ornare diam
                        sedasd commodo nibh ante facilisis bibendum dolor feugiat at.</p>
                </div>
            </div>
            <div class="col-md-4">
                <div class="service-media"><img src="img/services/urbain.jpg" alt=" "></div>
                <div class="service-desc">
                    <h3>plan d'urbanisation</h3>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis sed dapibus leo nec ornare diam
                        sedasd commodo nibh ante facilisis bibendum dolor feugiat at.</p>
                </div>
            </div>
            <div class="col-md-4">
                <div class="service-media"><img src="img/services/notaire.jpg" alt=" "></div>
                <div class="service-desc">
                    <h3>Transaction via un notaire</h3>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis sed dapibus leo nec ornare diam
                        sedasd commodo nibh ante facilisis bibendum dolor feugiat at.</p>
                </div>
            </div>
...
<div class="modal fade" role="dialog" id="signModal">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <form method="POST" action="{{ url('register.inscription') }}"
                ...
                <div class="modal-body">
                    ...
                    <fieldset class="radio">
                        <div class="radio">
                            <label for="status1" class="required"><input type="radio" name="status" value="1"
                                                                         id="status1"
                                                                         required="required"/> propriétaire : si vous
                                voulez
                                vendre ou louer vos biens</label>
                        </div>
                        <br>
                        <div class="radio">
                            <label for="status2"><input type="radio" name="status" value="2" id="status2"/> locataire :
                                si
                                vous chercher un bien pour louer</label>
                        </div>
                        <br>
                        <div class="radio">
                            <label for="status3"><input type="radio" name="status" value="3" id="status3"/> particulier
                                : si
                                vous voulez acheter un bien</label>
                        </div>
                        <br>
